...
pub const GENERATED_LINE_COUNT: usize = 8;
pub const GROUP_PEEL_MAX: u32 = 4;

pub const GENERATED_MARKERS: &[&[u8]] = &[
    b"@generated",
    b"auto-generated",
    b"autogenerated",
...
pub fn is_generated(source: &[u8]) -> bool {
    let mut lines = 0;
    let mut offset = 0;

    while offset < source.len() && lines < GENERATED_LINE_COUNT {
        let start = offset;
        ...
        for marker in GENERATED_MARKERS {
            if contains_folded(&source[start..offset], marker) {
                return true;
            }
        }
...
mod tests {
    ...
    #[test]
    fn a_generated_marker_in_the_head_marks_the_file() {
        assert!(is_generated(b"// Code generated by tool. DO NOT EDIT.\npackage main\n"));
        assert!(is_generated(b"\n\n\n# @generated\n"));
        assert!(!is_generated(b"fn main() {}\n"));
        assert!(!is_generated(b"1\n2\n3\n4\n5\n6\n7\n8\n// do not edit\n"));
    }
